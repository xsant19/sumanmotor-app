        ...
        <div
            ...
            <form action="">
                ...
                <textarea name="kendala"
                    class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                    rows="4" @disabled($order->status_order == 'Menunggu')>{{ $order->kendala }}</textarea>
                @if ($order->status_order == 'Sedang Diproses')
                    <label for="cars">Pilih Montir</label>
                    @foreach ($montirs as $montir)
                        <select id="cars" name="nama_montir">
                ...
                <div class="mt-6">
                    @if ($order->status_order == 'Menunggu')
                        <button type="button"
                            class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-gradient-to-tl from-blue-600 to-cyan-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"><a
                    ...
                    @endif
                    <button type="button"
                        class="ml-3 inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-white bg-gradient-to-tl from-red-600 to-rose-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"><a

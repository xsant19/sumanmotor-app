        ...
        <div
            ...
            <div class="flex-auto px-0 pt-0 pb-2 border-b border-gray-200">
                <form action="{{ route('montirs.store') }}" method="POST" class="p-6 pb-3 mb-3 bg-white rounded-t-2xl">
                    ...
                    <button type="submit"
                        class=" p-6 inline-block px-4 py-2 font-bold text-center bg-gradient-to-tl from-green-600 to-lime-400 uppercase align-middle transition-all rounded-lg cursor-pointer leading-pro text-xs ease-soft-in tracking-tight-soft shadow-soft-md bg-150 bg-x-25 hover:scale-102 active:opacity-85 hover:shadow-soft-xs text-white">Simpan</button>
                </form>
            </div>
        </div>
    @endsection

        ...
        <section class="pb-20 relative block bg-gray-900">
            ...
            <div class="container mx-auto px-4 lg:pt-24 lg:pb-64">
                <div class="flex flex-wrap text-center justify-center">
                    <div class="w-full lg:w-6/12 px-4">
                        <h2 class="text-4xl font-semibold text-white">Kontak Kami</h2>
                        <p class="text-lg leading-relaxed mt-4 mb-4 text-gray-500">
                            Terima kasih Anda telah menjadi pelanggan setia Bengkel Suman Motor. Sebagai bentuk komitmen
                            dalam
                            memberikan pelayanan terbaik, kami memberikan layanan agar Anda dapat mengetahui
                            informasi seputar bengkel, produk, dan promosi secara lengkap.
                            <br>
                            Silahkan hubungi kami melalui kontak dibawah ini dan kami berusaha untuk memberikan pelayanan
                            yang memuaskan untuk anda.
                        </p>
                    </div>
                </div>
